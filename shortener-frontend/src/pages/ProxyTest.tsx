    ...
    <div style={{ padding: 24 }}>
      <Card>
        ...
        <Paragraph>
          ...
          <br />
          • <Text type="success">代理请求</Text>：通过 Vite 代理发送请求，应该成功
          <br />
          • <Text type="danger">直接请求</Text>：直接向远程服务器发送请求，会被 CORS 阻止
          <br />
          • <Text type="tertiary">健康检查</Text>：测试代理服务器连通性
        </Paragraph>
        ...
        <Space wrap>
          ...
          <Button
            onClick={testCurrentUserWithToken}
            loading={loading}
          >
            测试获取用户信息
          </Button>
